SELECT MeasurementCategory.Object_ID, MeasurementCategory.ea_guid AS CLASSGUID , MeasurementCategory.Object_Type AS CLASSTYPE, MeasurementCategory.Name as MeasurementCategory, MeasurementArea.value AS MeasurementArea, Definition.value AS Definition, ID.value AS ID
