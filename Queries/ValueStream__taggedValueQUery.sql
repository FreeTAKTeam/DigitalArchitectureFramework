SELECT ValueStream.Object_ID, ValueStream.ea_guid AS CLASSGUID , ValueStream.Object_Type AS CLASSTYPE, ValueStream.Name as ValueStream, Criticality.value, isDecomposed.value, entrancecriteria.value, exitcriteria.value
