SELECT Actor.Object_ID, Actor.ea_guid AS CLASSGUID , Actor.Object_Type AS CLASSTYPE, Actor.Name as Actor, FTEs.value, ActorGoal.value, ActorType.value, ActorTasks.value
