SELECT Decision.Object_ID, Decision.ea_guid AS CLASSGUID , Decision.Object_Type AS CLASSTYPE, Decision.Name as Decision, SubjectArea.value, Topic.value, Assumptions.value, Motivation.value, Alternatives.value, Decision.value, Justification.value, Implications.value, RelatedDecisions.value
