-- Generated 2024-09-10 11:10:47 AM
 ...
 (                                                                                             
 	...
 	Inner join t_connector c on                                                                 
 							(o1.Object_ID = c.Start_Object_ID AND                               
 								c.Stereotype = 'is Associated To'   		                
 								)                                                               
 	inner join t_object o2 on (c.End_object_ID = o2.Object_ID 	AND o2.Stereotype = 'dOrganizationUnit')   
