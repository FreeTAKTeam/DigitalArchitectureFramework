SELECT Stakeholder.Object_ID, Stakeholder.ea_guid AS CLASSGUID , Stakeholder.Object_Type AS CLASSTYPE, Stakeholder.Name as Stakeholder, Legitimacy.value, Power.value, role.value, Urgency.value, Attitude.value, RACI.value, Knowledge.value
