-- Generated 2025-01-15 3:37:32 PM
 ...
 (                                                                                             
 	...
 	Inner join t_connector c on                                                                 
 							(o1.Object_ID = c.Start_Object_ID AND                               
 								c.Stereotype = 'dNetworkHasSecurityGroup'   		                
 								)                                                               
 	inner join t_object o2 on (c.End_object_ID = o2.Object_ID 	AND o2.Stereotype = 'dSecurityGroup')   
