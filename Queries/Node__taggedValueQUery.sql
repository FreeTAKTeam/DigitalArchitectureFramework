SELECT Node.Object_ID, Node.ea_guid AS CLASSGUID , Node.Object_Type AS CLASSTYPE, Node.Name as Node, IP.value, PublicIP.value, CPU.value, RAM.value, Owner.value, ArchitectureType.value, Disk.value
