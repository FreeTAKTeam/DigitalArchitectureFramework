SELECT DataEntity.Object_ID, DataEntity.ea_guid AS CLASSGUID , DataEntity.Object_Type AS CLASSTYPE, DataEntity.Name as DataEntity, PrivacyClassification.value, RetentionClassification.value, Category.value, ID.value, Owner.value, Source.value, isAccessible.value, isTimely.value, isAccurate.value
