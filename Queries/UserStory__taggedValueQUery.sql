SELECT UserStory.Object_ID, UserStory.ea_guid AS CLASSGUID , UserStory.Object_Type AS CLASSTYPE, UserStory.Name as UserStory, TestScenario.value, EstimatedEffort.value, StoryDetails.value
