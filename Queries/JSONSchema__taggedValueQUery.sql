SELECT JSONSchema.Object_ID, JSONSchema.ea_guid AS CLASSGUID , JSONSchema.Object_Type AS CLASSTYPE, JSONSchema.Name as JSONSchema, id.value, schema.value, schemaFileName.value
